...
def plot_evaluation_results(results, save_dir: Path, model_name: str):
    ...
    plot_path = save_dir / f"eval_{model_name}__results.png"
...
# ========== 3. 核心主函数 ==========
def main():
    parser = argparse.ArgumentParser(description="RL Navigation Evaluator (Eval)")
    ...
    try:
        ...
        env = TurtleBot3NaviEnv(runtime=runtime, env_config=env_config, rl_runtime_mode="eval")
